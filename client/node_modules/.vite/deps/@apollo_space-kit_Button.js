...
var require_main2 = __commonJS({
  "node_modules/@react-aria/ssr/dist/main.js"(exports, module) {
    ...
    var $97d95f6660b1bb14$var$SSRContext = (0, $parcel$interopDefault($32tCg$react)).createContext($97d95f6660b1bb14$var$defaultContext);
    var $97d95f6660b1bb14$var$IsSSRContext = (0, $parcel$interopDefault($32tCg$react)).createContext(false);
    function $97d95f6660b1bb14$var$LegacySSRProvider(props) {
      ...
      return (0, $parcel$interopDefault($32tCg$react)).createElement($97d95f6660b1bb14$var$SSRContext.Provider, {
        value
      }, (0, $parcel$interopDefault($32tCg$react)).createElement($97d95f6660b1bb14$var$IsSSRContext.Provider, {
        value: isSSR
      }, props.children));
    }
    ...
    function $97d95f6660b1bb14$export$9f8ac96af4b1b2ae(props) {
      if (typeof (0, $parcel$interopDefault($32tCg$react))["useId"] === "function") {
        ...
        return (0, $parcel$interopDefault($32tCg$react)).createElement((0, $parcel$interopDefault($32tCg$react)).Fragment, null, props.children);
      }
      return (0, $parcel$interopDefault($32tCg$react)).createElement($97d95f6660b1bb14$var$LegacySSRProvider, props);
    }
...
var require_main3 = __commonJS({
  "node_modules/@react-aria/utils/dist/main.js"(exports, module) {
    ...
    var $4068a0fae83b6d84$var$RouterContext = (0, $1Yh1N$react.createContext)({
      isNative: true,
    ...
    function $4068a0fae83b6d84$export$323e4fc2fa4753fb(props) {
      ...
      return (0, $parcel$interopDefault($1Yh1N$react)).createElement($4068a0fae83b6d84$var$RouterContext.Provider, {
        value: ctx
      }, children);
    }
    ...
    function $d796e7157ac96470$export$cfa2225e87938781(node, checkForOverflow) {
      ...
      if ($d796e7157ac96470$export$2bb74740c4e19def(scrollableNode, checkForOverflow))
        scrollableNode = scrollableNode.parentElement;
      while (scrollableNode && !$d796e7157ac96470$export$2bb74740c4e19def(scrollableNode, checkForOverflow))
        scrollableNode = scrollableNode.parentElement;
...
var require_main4 = __commonJS({
  "node_modules/@react-aria/interactions/dist/main.js"(exports, module) {
    ...
    var $01d3f539e91688c8$export$5165eccb35aaadb5 = (0, $parcel$interopDefault($goTMa$react)).createContext({
      register: () => {
      }
    });
    ...
    function $0294ea432cd92340$export$45712eceda6fad21(props) {
      ...
      (0, $goTMa$react.useEffect)(() => {
        return () => {
          ...
          if (!allowTextSelectionOnPress)
            (0, $f7e14e656343df57$export$b0d6fa1ab32e3295)((_ref_current_target = ref.current.target) !== null && _ref_current_target !== void 0 ? _ref_current_target : void 0);
        };
      }, [
        allowTextSelectionOnPress
      ]);
    ...
    function $e77252a287ef94ab$var$setupGlobalFocusEvents(element) {
      if (typeof window === "undefined" || $e77252a287ef94ab$export$d90243b58daecda7.get((0, $goTMa$reactariautils.getOwnerWindow)(element)))
        return;
    ...
    function $a3dbce0aed7087e2$export$2123ff2b87c81ca(props, ref) {
      ...
      (0, $goTMa$reactariautils.useEvent)(ref, "wheel", isDisabled ? void 0 : onScrollHandler);
    }
    ...
    function $3cd7b5d0eebf0ca9$export$c24ed0104d07eab9(props) {
      ...
      let descriptionProps = (0, $goTMa$reactariautils.useDescription)(onLongPress && !isDisabled ? accessibilityDescription : void 0);
      return {
  ...
  "node_modules/@react-aria/focus/dist/main.js"(exports, module) {
    ...
    function $a7a032acae3ddda9$export$20e40289641fbbb6(props) {
      ...
      (0, $aB6Cp$react.useEffect)(() => {
        const activeElement = (0, $aB6Cp$reactariautils.getOwnerDocument)(scopeRef.current ? scopeRef.current[0] : void 0).activeElement;
        let scope = null;
    ...
    function $a7a032acae3ddda9$var$useFocusContainment(scopeRef, contain) {
      ...
      (0, $aB6Cp$reactariautils.useLayoutEffect)(() => {
        ...
        const ownerDocument = (0, $aB6Cp$reactariautils.getOwnerDocument)(scope ? scope[0] : void 0);
        let onKeyDown = (e) => {
    ...
    function $a7a032acae3ddda9$var$useAutoFocus(scopeRef, autoFocus) {
      ...
      (0, $aB6Cp$react.useEffect)(() => {
        if (autoFocusRef.current) {
          $a7a032acae3ddda9$var$activeScope = scopeRef;
          const ownerDocument = (0, $aB6Cp$reactariautils.getOwnerDocument)(scopeRef.current ? scopeRef.current[0] : void 0);
    ...
    function $a7a032acae3ddda9$var$useRestoreFocus(scopeRef, restoreFocus, contain) {
      const nodeToRestoreRef = (0, $aB6Cp$react.useRef)(typeof document !== "undefined" ? (0, $aB6Cp$reactariautils.getOwnerDocument)(scopeRef.current ? scopeRef.current[0] : void 0).activeElement : null);
      (0, $aB6Cp$reactariautils.useLayoutEffect)(() => {
        let scope = scopeRef.current;
        const ownerDocument = (0, $aB6Cp$reactariautils.getOwnerDocument)(scope ? scope[0] : void 0);
              ...
              if (ownerDocument.activeElement === ownerDocument.body) {
                ...
                while (treeNode3) {
                  if (treeNode3.nodeToRestore && treeNode3.nodeToRestore.isConnected) {
                    $a7a032acae3ddda9$var$focusElement(treeNode3.nodeToRestore);
                    return;
                  }
                ...
                while (treeNode3) {
                  if (treeNode3.scopeRef && treeNode3.scopeRef.current && $a7a032acae3ddda9$export$d06fae2ee68b101e.getTreeNode(treeNode3.scopeRef)) {
                    $a7a032acae3ddda9$var$focusFirstInScope(treeNode3.scopeRef.current, true);
                    return;
                  }
                  treeNode3 = treeNode3.parent;
                }
