...
function defineInspect(classObject) {
  ...
  typeof fn === "function" || invariant4(0);
...
var printDocASTReducer = {
  ...
  VariableDefinition: function VariableDefinition(_ref) {
    ...
    return variable + ": " + type + wrap2(" = ", defaultValue) + wrap2(" ", join(directives, " "));
  },
  ...
  Field: function Field(_ref3) {
    ...
    var argsLine = prefix + wrap2("(", join(args, ", "), ")");
  ...
  FragmentDefinition: function FragmentDefinition(_ref7) {
    ...
    return (
      // Note: fragment variable definitions are experimental and may be changed
      // or removed in the future.
      "fragment ".concat(name).concat(wrap2("(", join(variableDefinitions, ", "), ")"), " ") + "on ".concat(typeCondition, " ").concat(wrap2("", join(directives, " "), " ")) + selectionSet
    );
  },
  // Value
  ...
  ObjectTypeDefinition: addDescription(function(_ref23) {
    ...
    return join(["type", name, wrap2("implements ", join(interfaces, " & ")), join(directives, " "), block(fields7)], " ");
  }),
  ...
  InterfaceTypeDefinition: addDescription(function(_ref26) {
    ...
    return join(["interface", name, wrap2("implements ", join(interfaces, " & ")), join(directives, " "), block(fields7)], " ");
  }),
  ...
  ObjectTypeExtension: function ObjectTypeExtension(_ref34) {
    ...
    return join(["extend type", name, wrap2("implements ", join(interfaces, " & ")), join(directives, " "), block(fields7)], " ");
  },
  InterfaceTypeExtension: function InterfaceTypeExtension(_ref35) {
    var name = _ref35.name, interfaces = _ref35.interfaces, directives = _ref35.directives, fields7 = _ref35.fields;
    return join(["extend interface", name, wrap2("implements ", join(interfaces, " & ")), join(directives, " "), block(fields7)], " ");
  },
...
function valueFromASTUntyped(valueNode, variables) {
  ...
  invariant4(0, "Unexpected value node: " + inspect(valueNode));
}
...
function astFromValue(value, type) {
  ...
  invariant4(0, "Unexpected input type: " + inspect(type));
}
    ...
    return {
      kind: {
        ...
        resolve: function resolve4(type) {
          ...
          invariant4(0, 'Unexpected type: "'.concat(inspect(type), '".'));
        }
      },
      name: {
        type: GraphQLString,
...
function typeFromAST(schema, typeNode) {
  ...
  invariant4(0, "Unexpected type node: " + inspect(typeNode));
}
...
function getDirectiveLocationForASTPath(ancestors) {
  ...
  !Array.isArray(appliedTo) || invariant4(0);
...
function getDirectiveLocationForOperation(operation) {
  ...
  invariant4(0, "Unexpected operation: " + inspect(operation));
}
...
function typeToExtKind(type) {
  ...
  invariant4(0, "Unexpected type: " + inspect(type));
}
function extensionKindToTypeName(kind) {
  ...
  invariant4(0, "Unexpected kind: " + inspect(kind));
}
...
var { toString: toString4, hasOwnProperty: hasOwnProperty7 } = Object.prototype;
            ...
            if (resolverMap) {
              ...
              if (resolve4) {
                resultPromise = Promise.resolve(
                  ...
                  cacheSlot.withValue(this.cache, resolve4, [
                    rootValue,
...
function getRenderDispatcher() {
  var _a2, _b;
  return (_b = (_a2 = React13.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _a2 === void 0 ? void 0 : _a2.ReactCurrentDispatcher) === null || _b === void 0 ? void 0 : _b.current;
}
...
var InternalQueryReference = (
  ...
  function() {
    ...
    InternalQueryReference2.prototype.createPendingPromise = function() {
      var _this = this;
      return wrapPromiseWithState(new Promise(function(resolve4, reject) {
        _this.resolve = resolve4;
        _this.reject = reject;
      }));
    };
